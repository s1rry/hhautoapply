...
class UserSettings(BaseModel):
    ...
    # По умолчанию required: письмо шлётся только где его просят. Экономит ИИ
    # и не спамит письмами туда, где они не нужны. Пользователь может включить
    # "always" сам. Кто уже настроил — не трогаем (дефолт только для новых).
    letter_mode: str = "required"
